...
public class EmployeeOutputViewTestValidator {
  public static void assertEmployeeViewIsCorrect(
      EmployeeOutputView employeeOutputView, String name, Long salary) {
    assertEquals(name, employeeOutputView.getName(), "Employee output view name is not correct");
    assertEquals(
        salary, employeeOutputView.getSalary(), "Employee output view salary is not correct");
  }

  public static void assertEmployeeViewIsCorrect(
      EmployeeOutputView employeeOutputView, Integer id, String name, Long salary) {
